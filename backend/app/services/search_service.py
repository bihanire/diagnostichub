...
PHRASE_REPLACEMENTS = {
    ...
    "green line": "screen lines",
    "screen lines on phone screen after update": "screen lines display",
    "screen lines on screen after update": "screen lines display",
    "vertical line": "screen lines",
    "screen protector lifting": "ghosttouch touch",
    ...
    "battery weak": "battery drain",
    "battery health weak": "battery drain",
    ...
    "service handover mode": "maintenancemode",
    "before service handover": "maintenancemode dispatch",
    "find my mobile": "findmymobile",
    "device finding lock": "findmymobile stolen lost",
    "device finding": "findmymobile",
    "device find": "findmymobile",
