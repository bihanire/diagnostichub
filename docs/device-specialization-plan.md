# Device Specialization Plan

## Goal

Keep the core complaint taxonomy stable while making the branch experience feel device-native, more predictive, and less likely to send branch-solvable devices to the service centre.
...
2. Device guidance overlay
The runtime layer in [device_guidance_service.py](/C:/Users/eatugonza/Documents/projects/diagnostichub/backend/app/services/device_guidance_service.py) adds Galaxy-specific customer-care wording, branch checks, and service handover advice without mutating the canonical procedure data.
...
## device-specific design principles

- Prefer branch-resolvable Device checks before courier escalation.
- Use Device Galaxy wording in customer-facing scripts.
- Reference device-native tools where they help branch diagnosis:
  - built-in support diagnostics
  - Battery and device care
  - Safe mode
  - device finding / Find My Mobile
...
4. Keep Device operational wording in the overlay layer unless the canonical procedure itself truly changes.
