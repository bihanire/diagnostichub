...
export const KNOWLEDGE_SOURCES: KnowledgeSource[] = [
  {
    id: "samsung-members-diagnostics",
    vendor: "Samsung",
    sourceType: "official_documentation",
    topic: "Samsung Members diagnostics",
    url: "https://www.samsung.com/us/support/answer/ANS10003632/",
    reviewedAt: REVIEWED_AT,
    allowedUsage: "paraphrase_and_link",
    copyrightStatus: "link_only_no_copying",
    teachingSummary:
      "Samsung Members can support branch learning by giving model-dependent diagnostic signals for battery, charging, touch, SIM, network, speaker, microphone, Wi-Fi, sensors, and related device checks.",
  },
  {
    id: "samsung-maintenance-mode",
    vendor: "Samsung",
    sourceType: "official_documentation",
    topic: "Maintenance Mode and repair privacy",
    url: "https://www.samsung.com/us/support/answer/ANS10003675/",
    reviewedAt: REVIEWED_AT,
    allowedUsage: "paraphrase_and_link",
    copyrightStatus: "link_only_no_copying",
    teachingSummary:
  ...
  {
    id: "samsung-service-readiness",
    vendor: "Samsung",
    sourceType: "official_documentation",
    topic: "Preparing a device for service",
    url: "https://www.samsung.com/us/support/answer/ANS10002816/",
    reviewedAt: REVIEWED_AT,
    allowedUsage: "paraphrase_and_link",
    copyrightStatus: "link_only_no_copying",
    teachingSummary:
  ...
  {
    id: "samsung-smartthings-find",
    vendor: "Samsung",
    sourceType: "official_documentation",
    topic: "SmartThings Find / lost device protection",
    url: "https://www.samsung.com/us/support/answer/ANS10002539/",
    reviewedAt: REVIEWED_AT,
    allowedUsage: "paraphrase_and_link",
    copyrightStatus: "link_only_no_copying",
    teachingSummary:
  ...
  {
    id: "samsung-device-care",
    vendor: "Samsung",
    sourceType: "official_documentation",
    topic: "Device Care optimization",
    url: "https://www.samsung.com/us/support/answer/ANS10001953/",
    reviewedAt: REVIEWED_AT,
    allowedUsage: "paraphrase_and_link",
    copyrightStatus: "link_only_no_copying",
    teachingSummary:
  ...
  {
    id: "samsung-safe-mode",
    vendor: "Samsung",
    sourceType: "official_documentation",
    topic: "Safe Mode for app-caused behavior",
    url: "https://www.samsung.com/us/support/answer/ANS10003495/",
    reviewedAt: REVIEWED_AT,
    allowedUsage: "paraphrase_and_link",
    copyrightStatus: "link_only_no_copying",
    teachingSummary:
  ...
  {
    id: "samsung-software-update",
    vendor: "Samsung",
    sourceType: "official_documentation",
    topic: "Galaxy software updates",
    url: "https://www.samsung.com/us/support/answer/ANS10002027/",
    reviewedAt: REVIEWED_AT,
    allowedUsage: "paraphrase_and_link",
    copyrightStatus: "link_only_no_copying",
    teachingSummary:
  ...
  {
    id: "samsung-screen-flicker",
    vendor: "Samsung",
    sourceType: "official_documentation",
    topic: "Screen flickering or glitching",
    url: "https://www.samsung.com/us/support/troubleshoot/TSG10004671/",
    reviewedAt: REVIEWED_AT,
    allowedUsage: "paraphrase_and_link",
    copyrightStatus: "link_only_no_copying",
    teachingSummary:
  ...
  {
    id: "samsung-factory-reset",
    vendor: "Samsung",
    sourceType: "official_documentation",
    topic: "Factory reset and data risk",
    url: "https://www.samsung.com/us/support/answer/ANS10002030/",
    reviewedAt: REVIEWED_AT,
    allowedUsage: "paraphrase_and_link",
    copyrightStatus: "link_only_no_copying",
    teachingSummary:
  ...
  },
  {
    ...
    url: "https://docs.samsungknox.com/admin/knox-manage/original-console/configure/profile/configure-profile-policies/android-enterprise-policies/",
    reviewedAt: REVIEWED_AT,
    allowedUsage: "paraphrase_and_link",
    copyrightStatus: "link_only_no_copying",
    teachingSummary:
  ...
  },
  {
    ...
    url: "https://docs.samsungknox.com/admin/knox-guard/how-to-guides/manage-devices/lock-and-unlock-devices/",
    reviewedAt: REVIEWED_AT,
    allowedUsage: "paraphrase_and_link",
    copyrightStatus: "link_only_no_copying",
    teachingSummary:
  ...
  },
  {
    ...
    url: "https://docs.samsungknox.com/admin/knox-configure/how-to-guides/devices/enroll-a-device/",
    reviewedAt: REVIEWED_AT,
    allowedUsage: "paraphrase_and_link",
    copyrightStatus: "link_only_no_copying",
    teachingSummary:
...
export const TEACHING_GUIDANCE: TeachingGuidance[] = [
  {
    ...
    title: "Use Samsung diagnostics as evidence, not as the final decision",
    ...
    teach:
      "When the phone is usable, Samsung Members diagnostics can help the officer learn which function is failing. The final branch decision still comes from the guided Watu flow.",
    branchSafeChecks: [
  ...
  },
  {
    ...
    sourceIds: ["samsung-maintenance-mode", "samsung-service-readiness", "watu-sop-pack"],
  },
  {
